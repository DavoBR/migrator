...
class ServiceItem extends ItemInFolder {
  ...
  bool get isEnabled => _serviceDetail.getElement('l7:Enabled').text == 'true';

  String get urlPattern => _httpMapping.getElement('l7:UrlPattern').text;

  List<String> get verbs => _httpMapping
      .getElement('l7:Verbs')
      .children
  ...
  XmlElement get _httpMapping => _serviceMappings.getElement('l7:HttpMapping');
}
